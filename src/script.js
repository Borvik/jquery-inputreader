(function($) {
    ...
    function processInput(e) {
      ...
      if (e.key.match(charRegex)) {
        ...
        var found = false;
        switch(e.key) {
          case 'Tab': found = "\t"; break;
          case 'Enter': found = "\n"; break;
          case 'ArrowLeft': found = "\u2190"; break;
          case 'ArrowUp': found = "\u2191"; break;
          case 'ArrowRight': found = "\u2192"; break;
          case 'ArrowDown': found = "\u2193"; break;
          case 'Shift': found = false; break; //found = "\u21E7"; break;
          case 'Backspace': found = "\u232B"; break;
          case 'Delete': found = "\u2326"; break;
          case 'End': found = "\u2198"; break;
          case 'Control': found = "\u2303"; break;
          case 'F1': found = "\u2460"; break;
          case 'F2': found = "\u2461"; break;
          case 'F3': found = "\u2462"; break;
          case 'F4': found = "\u2463"; break;
          ...
          case 'F8': found = "\u2467"; break;
          case 'F9': found = "\u2468"; break;
          case 'F10': found = "\u2469"; break;
          case 'F11': found = "\u246A"; break;
          case 'F12': found = "\u246B"; break;
          default: console.log(e.key, e.which, e);
        }
        if (found) {
          scanbuffer[idx].push(found);
        }
      }
    ...
    function processSpecialKey(e) {
      var specialKeys = ["\u2190", "\u2191", "\u2192", "\u2193", "\u21E7", "\u232B", "\u2326",
        ...
        "\u2467", "\u2468", "\u2469", "\u246A", "\u246B",
        "\t", "\n"];
      return specialKeys.indexOf(e.scandata) > -1;
    }
    ...
    function processScanData(idx) {
      ...
      if (scanbuffer[idx].length) {
        ...
        if ($.fn.inputreader.defaults.insertText && typeof element.selectionStart !== 'undefined' && !event.isDefaultPrevented()) {
          if (processSpecialKey(event)) return;
